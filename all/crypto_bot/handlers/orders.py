...
from all.crypto_bot.handlers.default_buttons import global_menu_reply, global_menu
from all.crypto_bot.services.event_playground import event_service
from all.crypto_bot.states.tier_state import AddOrderState, EnterOrderState
...
async def my_orders(callback: types.CallbackQuery):
    ...
    await callback.message.edit_text("Выберите событие", reply_markup=inline_kb)
