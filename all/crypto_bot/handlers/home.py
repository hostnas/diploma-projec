...
import re
from all.crypto_bot.handlers.default_buttons import first_menu, global_menu_reply, global_menu
from all.crypto_bot.services.event_playground import event_service
from all.crypto_bot.states.tier_state import RegistrationState, AuthorizationState
